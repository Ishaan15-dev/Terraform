...
module "asg" {
  source = "git::https://snatakSneha:ghp_UeRp1z3IoFvm@github.com/Snaatak-Cloudops-Crew/IAC-Terraform-repo.git//Terraform/Module/Infra/Auto-Scalable?ref=SCRUM-492-tina"
  ...
  security_group_id = data.terraform_remote_state.otms_ns_main.outputs.security_group_ids["employee"]
